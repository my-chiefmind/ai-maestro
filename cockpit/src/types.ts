...
export interface UsageBucket extends UsageMetrics { key: string; label?: string }
...
export type UsageTiming = 'exact' | 'estimated' | 'mixed' | 'application';
export type UsageConfidence = 'exact' | 'high' | 'medium' | 'unassigned' | 'application';
...
export interface UsageReport {
  generatedAt: string; schema: number; project: string;
