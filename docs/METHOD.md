...
This is the working method Maestro packages. It came out of running a multi-repo product
...
isolated worktrees, a gated prod track, and honest hygiene.** Maestro is just the scaffolding
