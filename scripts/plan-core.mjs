 ...
 * completeness maths, the Markdown mirror, and the web dashboard's Plan tab all read this, so a new
 ...
 * the web dashboard and a silently-skipped scope check in the orchestrator.
 */
...
export function renderPlanMd(planRaw, projectName = "Project") {
  ...
  L.push(`_Edit it in the web dashboard's **Plan** tab, or run \`/plan-update\`._`);
  L.push("");
